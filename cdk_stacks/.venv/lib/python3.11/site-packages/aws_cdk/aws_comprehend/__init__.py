    ...
    class DocumentClassifierInputDataConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param test_s3_uri: This specifies the Amazon S3 location where the test annotations for an entity recognizer are located. The URI must be in the same AWS Region as the API endpoint that you are calling.
