    ...
    class PardotConnectorProfilePropertiesProperty:
        def __init__(
            ...
            *,
            ...
            :param instance_url: 
            :param is_sandbox_environment: Indicates whether the connector profile applies to a demo or production environment.
    ...
    class RedshiftConnectorProfilePropertiesProperty:
        def __init__(
            ...
            *,
            ...
            :param data_api_role_arn: 
            :param database_name: 
            :param database_url: The JDBC URL of the Amazon Redshift cluster.
            :param is_redshift_serverless: If Amazon AppFlow will connect to Amazon Redshift Serverless or Amazon Redshift cluster.
    ...
    class SalesforceConnectorProfilePropertiesProperty:
        def __init__(
            ...
            *,
            ...
            :param use_private_link_for_metadata_and_authorization: Indicates whether to make Metadata And Authorization calls over Pivate Network.
...
class CfnFlow(
    ...
    def __init__(
        ...
        *,
        ...
        :param kms_arn: The ARN (Amazon Resource Name) of the Key Management Service (KMS) key you provide for encryption. This is required if you do not want to use the Amazon AppFlow-managed KMS key. If you don't provide anything here, Amazon AppFlow uses the Amazon AppFlow-managed KMS key.
        :param metadata_catalog_config: Configurations of metadata catalog of the flow.
    ...
    class MetadataCatalogConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param glue_data_catalog: Trigger settings of the flow.
    ...
    class S3OutputFormatConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param preserve_source_data_typing: 
