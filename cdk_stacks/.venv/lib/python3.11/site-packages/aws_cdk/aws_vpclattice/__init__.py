    ...
    class HeaderMatchProperty:
        def __init__(
            ...
            *,
            ...
            :param case_sensitive: Indicates whether the match is case sensitive. Defaults to false. Default: - false
    ...
    class TargetGroupConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param ip_address_type: The type of IP address used for the target group. The possible values are ``ipv4`` and ``ipv6`` . This is an optional parameter. If not specified, the IP address type defaults to ``ipv4`` . Default: - "IPV4"
